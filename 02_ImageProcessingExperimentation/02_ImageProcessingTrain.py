...
Summary:
    - Python function script to run Image Processing Enhancement on the Images (train set)
...
# Reading in raw data
df = pd.read_csv("trainDataAnalysis.csv")
df["PSNR_CLAHE"] = 0
df["SSIM_CLAHE"] = 0
df["MSE_CLAHE"] = 0
...
basePath = "C:\\Users\\User\\Documents\\Masters in AI\\GITractClassification" + "\\05_Dataset\\OriginalDatasetSplitted\\train\\"
...
# df.to_csv('trainDataAnalysisUpdated.csv',index = False)
print("The End")