...
Summary:
    - Python function script to run Image Processing Enhancement on the Images (test set)
...
# Reading in raw data
df = pd.read_csv("testDataAnalysis.csv")
df["PSNR_CLAHE"] = 0
df["SSIM_CLAHE"] = 0
df["MSE_CLAHE"] = 0
...
basePath = "C:\\Users\\User\\Documents\\Masters in AI\\GITractClassification" + "\\05_Dataset\\OriginalDatasetSplitted\\test\\"
...
for image_id in df["image_id"]:
    ...
    # Read te raw image and convert ot RGB format
...
#     
    ...
    """
    # Commented as to not interrupt already available images in project folder. Uncomment to rerun and process image again
    ...
    # Print counter to update
    print(counter)
    print("DONE FOR IMAGE: " + image_path + " Index no: " + str(index))

# # Save results to csv file
# df.to_csv('testDataAnalysisUpdated.csv',index = False)
print("The End")